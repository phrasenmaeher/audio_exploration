...
import os
from audio_loading_utils import load_audio_sample, plot_log_spectrogram
...
def build(data: dict, show_names=False):
    ...
    :return:
    """
    st.markdown("<h1 style='text-align: center; color: black;'>Showing log scaled spectrograms</h1>",
