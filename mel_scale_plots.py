...
import os
from audio_loading_utils import load_audio_sample, plot_mel_spectrogram
...
def build(data: dict, show_names:bool=False):
    ...
    :return:
    """
    st.markdown("<h1 style='text-align: center; color: black;'>Showing mel-scaled spectrograms</h1>",
